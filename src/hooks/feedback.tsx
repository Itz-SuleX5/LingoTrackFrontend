...
export const useSubmitForm = (wordBase: string) => {
  ...
  const submitForm = async (formData: FormData) => {
    try {
      ...
      const prompt = `Evalúa estas oraciones en inglés con el verbo "${wordBase}" dale importancia al verbo y tiempo respectivo:

Simple Present: ${formData.simplePresent}
Present Progressive: ${formData.presentProgressive}
Simple Past: ${formData.simplePast}
Past Progressive: ${formData.pastProgressive}
...
OK: Simple Present | OK: Present Progressive | OK: Simple Past | OK: Past Progressive

o

BAD: Simple Present → [oración corregida (explicación corta en español)] | BAD: Present Progressive → [oración corregida (explicación corta en español)] | BAD: Simple Past → [oración corregida (explicación corta en español)] | BAD: Past Progressive → [oración corregida (explicación corta en español)]

6. Separa las cuatro evaluaciones con " | ".
...
8. Sé extremadamente conciso: una sola línea y nada más.`;
      ...
      console.error('Error en submitForm:', err.message);
